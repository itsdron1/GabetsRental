...
export const WHATSAPP_BOOKING_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
  "Hi! I just filled in the booking form on G-BIKE Rental Bali. Can you confirm my reservation?",
)}`;
